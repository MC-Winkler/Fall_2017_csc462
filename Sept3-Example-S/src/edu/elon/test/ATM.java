...
public class ATM {
	 ...
	 * 
	 * @param balance
	 *            non negative amount of money to deposit
	 */
	public ATM(double balance) throws IllegalArgumentException {
		if (balance < 0.0) {
	 ...
	 * 
	 * @param amount
	 *            a positive value for money to be deposited
	 * @throws IllegalArgumentException
	 *             if requested deposit is less then 0
	 */
	 ...
	 * exception if the user does not have the balance to cover the withdrawal.
	 * 
	 * @param amount
	 *            double value that is >= current balance
	 * @return double value of amount actually withdrawn
	 * @throws IllegalArgumentException
	 *             if request withdraw amount is less than the amount currently
	 *             in account balance.
	 */
